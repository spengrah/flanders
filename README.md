...
cp -r skill/ /path/to/your/project/.claude/skills/flanders/

# Option B: .ai skills directory (if using .ai scaffolding)
cp -r skill/ /path/to/your/project/.ai/skills/flanders/
```
...
### 3. Configure lint + test commands

Create `.ai/pre-push.json` in your project (the pre-commit hook reads this):
